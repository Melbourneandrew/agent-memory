...
**Workspace package (not published on its own).** It is bundled into the root [`@melbourneandrew/agent-memory-cli`](https://www.npmjs.com/package/@melbourneandrew/agent-memory-cli) npm release and consumed by the Next.js app at build time.
